...
public class DataAnalysis {
    ...
    public static void main(String[] args) {
        ...
        File file = new File("E:\\watdiv.json");
        JsonNode rootNode;
        ...
        System.out.println("VP表为一对一的表的个数：" + falseNum + " 百分比：" + ((double) falseNum / size));
        System.out.println("VP表不是一对一的表的个数：" + trueNum + " 百分比：" + (trueNum / (double) size));
    }
}
